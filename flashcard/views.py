...
def novo_flashcard(request):
    ...
    if request.method == 'GET':
        ...
        if categoria_filtrar:
            flashcards = Flashcard.objects.filter(categoria__id=categoria_filtrar)
        if dificuldade_filtrar:
            flashcards = Flashcard.objects.filter(dificuldade=dificuldade_filtrar)
...
def deletar_flashcard(request, id):
    ...
    flashcard.delete()
    messages.add_message(request, messages.constants.SUCCESS, 'Flashcard deletado com sucesso!')
    return redirect('/flashcard/novo_flashcard/')
